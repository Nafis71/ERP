...
{
  header('location:../backend/redirect_searcherror.php?indicate=5');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<?php echo'<span>Total Entries found '.mysqli_num_rows($result).' & Showing Page Number '.$page.'</span>';?>
      ...
      <thead>
        <tr>
          <form action="../hrm/attendance_search.php" method="GET">
          ...
          <th colspan="2"class="head1">
              <input class="datepicker" type="month" name="month" required="required">
                ...
                <div class="controls">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input id="form_id" type="text" name="id" class="form-control" placeholder="Employee ID*"  required="required" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="datepicker" type="time" name="outtime"required="required">
          ...
          <div class="col-lg-7 mx-auto">
             ...
             <div class="col-md-6">
                        ...
                        <div class="form-group">
                                ...
                                <input id="form_id" type="text" name="holiday" class="form-control" placeholder="Total Holidays *" multiple size="50" required="required" >
